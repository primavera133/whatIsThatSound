...
controller('ChooseController', ['$scope', 'BgService', 'LanguageService', function ($scope, bgService, langService) {
    $scope.langService = langService;

    bgService.setBg('choose');

}]).
controller('PlayController', ['$scope', '$http', '$route', 'ngAudio', 'BgService', 'GameService', 'LanguageService',
    function ($scope, $http, $route, ngAudio, bgService, gameService, langService) {
        var hasBeenTrieds = [];
